...
Template.topRareAchievements.events({
	...
	"mouseover .panel-heading": function() {
		$('.bg-rare .view-button').removeClass("inline");
		$('.bg-rare .view-button').addClass("none");
		$('.bg-rare .view-arrow').removeClass("none");
		$('.bg-rare .view-arrow').addClass("inline");
	},
	"mouseout .panel-heading": function() {
		$('.bg-rare .view-button').removeClass("none");
		$('.bg-rare .view-button').addClass("inline");
		$('.bg-rare .view-arrow').removeClass("inline");
		$('.bg-rare .view-arrow').addClass("none");
	}
});
