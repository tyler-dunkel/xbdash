...
Template.gamesChart.created = function() {
	var self = this;
	self.subscribe('dashboardGameGenreChart');
}
...
Template.gamesChartSvg.rendered = function() {
	...
	nv.addGraph(function() {
		var gameChart = nv.models.pieChart()
		...
		d3.select("#games-chart svg").datum(formattedGameData).transition().duration(350).call(gameChart);
