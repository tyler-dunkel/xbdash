...
Router.map(function() {
	...
	// 	controller: 'DashboardController',
	// 	waitOn: function() {
	// 		Meteor.subscribe('myGamesList', slug);
	// 	},
	// 	fastRender: true
	// });
	// this.route('allGames', {
	...
	// 	controller: 'DashboardController',
	// 	waitOn: function() {
	// 		Meteor.subscribe('allGamesList', slug);
	// 	},
	// 	fastRender: true
	// });
	// this.route('/allGames/:genre', {
	// 	name: 'genre',
	// 	path: '/games/:genre',
	// 	template: 'allGames',
	// 	controller: 'DashboardController',
	// 	waitOn: function() {
	// 		var genre = Router.current().params.slug;
	// 		Meteor.subscribe('singleGenre', genre);
	// 	},
	// 	fastRender: true
	// });
	// this.route('/achievementsGenrePage/:tier', {
	// 	name: 'achievementsGenre',
	// 	path: '/achievements/:tier',
	// 	template: 'achievementsTierPage',
	// 	controller: 'DashboardController',
	// 	waitOn: function() {
	// 		var tier = Router.current().params.slug;
	// 		Meteor.subscribe('singleAchievement', tier);
	// 	},
	// 	fastRender: true
	// });
});
